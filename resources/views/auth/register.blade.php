            ...
            <div class="container">
                <div class="row align-items-center justify-content-center">
                    <div class="col-md-8">
                        ...
                        <form class="pt-4" action="{{route('register')}}" method="post">
                            @csrf
                            <div class="form-group first mb-3">
                                <label for="username">Full Name</label>
                                <input type="text" class="form-control" name="name" value="{{old('name')}}" placeholder="Enter Your Name" id="name" required>
                                @error('name')
                            ...
                            <div class="form-group last mb-3">
                                <div class="form-group first mb-3">
                                    ...
                                    <input type="text" class="form-control" name="email" value="{{old('email')}}" placeholder="Enter Your E-Mail / Phone Number" id="email"
                                           required>
                                    @error('email')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                ...
                                <div class="d-flex flex-column flex-sm-row pt-4 align-items-center gap-4">
                                    <button type="submit" class="btn rounded-5 btn-primary btn-block">Sign Up</button>
                                    <p class="p-0 m-0">Already have an account? <a href="{{route('login')}}" class="primary-text">Log In</a></p>
                                </div>
                            </div>
                        </form>
                    </div>
